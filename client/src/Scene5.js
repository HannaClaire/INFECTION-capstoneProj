...
class Scene3 extends Phaser.Scene {
    ...
    create() {  
       ...
       // const canvasHeight = this.scale.canvas.height;
        const text = this.add.text(canvasWidth/2, 100, "You Win!" ,{ fontFamily: 'Farro', fontSize: "76pt", align: "center", color:"black", position: "absolute", strokeThickness: 5}).setOrigin(0.5)
